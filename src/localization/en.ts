...
export const en : Record<LocalizationName, string> = {
    ...
    [LocalizationName.titleSettings] : "Settings",
    [LocalizationName.themeDark2] : "Dark theme 2",
    [LocalizationName.idAddress] : "Ip Address",
    [LocalizationName.collisionDomain] : "Collision domain",
    [LocalizationName.newInterface] : "New interface",
    [LocalizationName.delete] : "Delete",
    [LocalizationName.invalidCIDR] : "Invalid CIDR",
    [LocalizationName.invalidIP] : "Invalid IP",
    [LocalizationName.StartupCommands] : "Startup Commands",
    [LocalizationName.newCommand] : "New command",
    [LocalizationName.optionalsParameters] : "Optionals parameters",
    [LocalizationName.shutdownCommands] : "Shutdown commands",
    [LocalizationName.deviceName] : "Device name",
    [LocalizationName.invalidName] : "Invalid name",
}
