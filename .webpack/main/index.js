    ...
    function electronAPI() {
        ...
        this.initialize = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                electron_1.ipcMain.handle("cmd:ping", function (_) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        try {
                            this.exec('ping 0.0.0.0', function (error, stdout, stderr) {
                                /* eslint-disable */ ;
                                (oo_oo(), console.log(stdout, "5b1accc4_0"));
                            });
                        }
                        catch (err) {
                            console.warn(err);
